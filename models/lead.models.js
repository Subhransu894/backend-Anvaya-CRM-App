...
const leadSchema = new mongoose.Schema({
    ...
    salesAgent:{
        ...
        ref:'SalesAgent',
        required:[true,'SalesAgent is required'],
    },
    status:{
        type:String,
        required:true,
...
//pre() - is a middleware , it runs before execute a new task. ex: here it will update date at "updateAt" filed before each save.
